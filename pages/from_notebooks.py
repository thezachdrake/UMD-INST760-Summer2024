...
axs[1, 1].set_xlabel('')
axs[1, 1].set_ylabel('')
fig.text(0.5, 0.04, 'Employment Outcomes', ha='center', va='center', fontsize=15)
fig.text(0.08, 0.66, 'Academic Reputation', ha='center', va='center', rotation='vertical', fontsize=12)
fig.text(0.08, 0.30, 'Employer Reputation', ha='center', va='center', rotation='vertical', fontsize=12)
