...
sns.regplot(x='Employment Outcomes', y='Academic Reputation', data=am_df[am_US_schools], ax=axs[0, 0], color='black', scatter_kws={'s':15})
axs[0, 0].set_title('US Schools', fontsize=18, color='black', y=1.01, fontweight='bold')
axs[0, 0].set_xlabel('')
axs[0, 0].set_ylabel('')
axs[0, 0].set_facecolor("lightblue")
sns.regplot(x='Employment Outcomes', y='Academic Reputation', data=am_df[am_int_schools], ax=axs[0, 1], color='black', scatter_kws={'s':15})
axs[0, 1].set_title('International Schools', fontsize=18, color='black', y=1.01, fontweight='bold')
axs[0, 1].set_xlabel('')
axs[0, 1].set_ylabel('')
axs[0, 1].set_facecolor("thistle")
sns.regplot(x='Employment Outcomes', y='Employer Reputation', data=am_df[am_US_schools], ax=axs[1, 0], color='black', scatter_kws={'s':15})
axs[1, 0].set_xlabel('')
axs[1, 0].set_ylabel('')
axs[1, 0].set_facecolor("lightblue")
sns.regplot(x='Employment Outcomes', y='Employer Reputation', data=am_df[am_int_schools], ax=axs[1, 1], color='black', scatter_kws={'s':15})
axs[1, 1].set_xlabel('')
axs[1, 1].set_ylabel('')
axs[1, 1].set_facecolor("thistle")
