...
def emp_outcome_corr(x, y, data, ax, title, color):
    ...
    ax.set_title(title, fontsize=32, color='black', y=1.05, fontweight='bold')
...
result = sns.scatterplot(data=location_in_us, x='employment_outcomes', y='academic_reputation', hue='size', palette='Set2', alpha=0.7, ax=ax)
