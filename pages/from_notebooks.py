...
fig.text(0.02, 0.75, 'Academic Reputation', ha='center', va='center', rotation='vertical')
fig.text(0.02, 0.25, 'Employer Reputation', ha='center', va='center', rotation='vertical')
