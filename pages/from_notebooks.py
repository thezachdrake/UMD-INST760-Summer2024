...
axs[1, 1].set_xlabel('')
axs[1, 1].set_ylabel('')
fig.text(0.5, 0.1, 'Employment Outcomes', ha='center', va='center', fontsize=15)
fig.text(0.1, 0.73, 'Academic Reputation', ha='center', va='center', rotation='vertical', fontsize=15)
fig.text(0.1, 0.28, 'Employer Reputation', ha='center', va='center', rotation='vertical', fontsize=15)
