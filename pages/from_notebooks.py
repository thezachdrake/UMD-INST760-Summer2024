...
squirrel = sns.boxplot(x="Sustainability",y="Size",hue="domestic_schools",data=jh_df,order=['S', 'M', 'L', 'XL'],legend="auto",width=0.7,gap=0.1,flierprops={"marker": "x"},fill=False)
